 ...
 *
 * Extends the member create flow with:
 *  - member_uuid (required) — the member this order belongs to
 *  - mark_as_paid_offline (optional) — skip ECPay, immediately mark paid
 */
class CreateAdminOrderRequest extends BaseApiRequest
{
    public function rules(): array
    {
        return [
            ...
            // Admin-only: skip ECPay, immediately mark as paid offline
            'mark_as_paid_offline' => ['nullable', 'boolean'],
        ];
    }
